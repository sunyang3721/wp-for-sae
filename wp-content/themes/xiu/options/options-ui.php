...
function opshui_page() {
    ...
    <div style="color:#999;">xiu主题由大前端设计及开发，为了保障该主题性能，我们不加密、不设防，同时也期待您保护自己的购买权益，请“偷偷”使用并尊重开发者成果。 <a target="_blank" href="http://www.daqianduan.com/theme">点此咨询开发者</a> 主题定制请邮件联系：haozi@daqianduan.com</div>
    ...
    <div id="opshui-metabox" class="metabox-holder">
		...
		<?php echo '<div class="opshui-sidebar"><div class="opshui-sidebar-widget"><a href="http://cnrdn.com/TkDE" target="_blank"><img src="'.THEME_URI.'/options/assets/images/ui-02.jpg"></a></div><div class="opshui-sidebar-widget"><a href="http://cnrdn.com/UkDE" target="_blank"><img src="'.THEME_URI.'/options/assets/images/ui-01.jpg"></a></div><iframe id="xiuxiu2" src="http://cnrdn.com/hkDE" frameborder="0" style="display:none"></iframe></div>'; ?>
	</div>
